...
This Morphe and Revanced builder creates [Magisk](https://github.com/topjohnwu/Magisk)/[KernelSU](https://github.com/tiann/KernelSU) modules and also APKs for [ReVanced](https://github.com/revanced) and [Morphe](https://github.com/MorpheApp) versions of YouTube and YouTube Music.
